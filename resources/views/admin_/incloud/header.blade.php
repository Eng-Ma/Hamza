        ...
        <div class="main-header-left ">
            <div class="responsive-logo">
                <a href="{{route('web.index')}}" class="header-logo">
                    <img src="{{ asset('adminassets/assets/img/brand/Luma.jpg') }}')}}" class="logo-1" alt="logo">
                    <img src="{{ asset('adminassets/assets/img/brand/Luma.jpg') }}" class="dark-logo-1"
                        alt="logo">
                </a>
            </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                    <ul class="nav nav-item  navbar-nav-right ms-auto">
                        <li class="">
                            <div class="dropdown  nav-item countries">
                                <a href="javascript:void(0);" data-bs-toggle="dropdown"
                                    class="d-flex  nav-item nav-link country-flag1" data-bs-toggle="dropdown"
                                    aria-expanded="false">
                        ...
                        <li class="dropdown nav-item main-header-message ">
                            <a class="new nav-link" data-bs-toggle="dropdown" href="javascript:void(0);"><svg
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="main-notification-list Notification-scroll">
                                    ...
                                    @empty
                                        <div class="d-flex p-3 border-bottom">
                                            <div class="ms-3">
                                                <h5 class="notification-label mb-1">لا توجد إشعارات جديدة</h5>
                                            </div>
                                        </div>
                                    @endforelse
                                </div>
                        ...
                        <li class="dropdown main-profile-menu nav nav-item nav-link">
                            <a class="profile-user d-flex" href="" data-bs-toggle="dropdown"><img
                                    alt="" src="{{ asset('adminassets/assets/img/users/6.jpg') }}"></a>
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="{{ route('admin.reset.password') }}"><i
                                ...
                                <form action="{{ route('admin.logout') }}" method="POST" class="d-flex">
                                    @csrf
                                    @method('delete')
                                    <button class="dropdown-item" style="border: 0; outline: 0;" type="submit"><i
