        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('admin.settings.create') }}" class="btn btn-success">Add Setting</a>
                </div>
                <div class="card-body">
                        ...
                        <table id="file-datatable" class="table table-bordered text-nowrap key-buttons">
                            <thead>
                                <tr>
                                    ...
                                    <th class="border-bottom-0">logo_header</th>
                                    <th class="border-bottom-0">logo_footer</th>
                                    <th class="border-bottom-0">Terms_and_Conditions</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($setting->logo_header)
                                                <img src="{{ asset('uploads/logo_header/settings/' . $setting->logo_header) }}"
                                                    alt="Setting Image" style="max-width: 100px; max-height: 100px;">
                                            @else
                                                <span>No Image</span>
                                            @endif
                                        </td>
                                        <td>
                                            @if ($setting->logo_footer)
                                                <img src="{{ asset('uploads/logo_footer/settings/' . $setting->logo_footer) }}"
                                                    alt="Setting Image" style="max-width: 100px; max-height: 100px;">
                                            @else
                                                <span>No Image</span>
                                            @endif
                                        ...
                                        <td>
                                            @if ($setting->status == StatusEnum::ACTIVE)
                                                <a href="{{ route('admin.settings.toggle_active', ['id' => $setting->id]) }}"
                                                    class="btn text-white" style="background: #4FE39C">
                                                    <i class="fa fa-check"></i>
                                                </a>
                                            @elseif($setting->status == StatusEnum::INACTIVE)
                                                <a href="{{ route('admin.settings.toggle_active', ['id' => $setting->id]) }}"
                                        ...
                                        <td>
                                            ...
                                            <form class="d-inline"
                                                action="{{ route('admin.settings.delete', ['id' => $setting->id]) }}"
                                                method="POST">
                                                @csrf
