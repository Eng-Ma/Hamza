        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <a href="{{ route('admin.abouts.create') }}" class="btn btn-success">Add Abouts</a>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($abouts as $about)
                                    <tr>
                                        ...
                                        <td>
                                            @if ($about->image)
                                                <img src="{{ asset('uploads/image/abouts/' . $about->image) }}" alt="Page Image"
                                        ...
                                        <td>
                                            @if ($about->status == StatusEnum::ACTIVE)
                                                <a href="{{ route('admin.abouts.toggle_active', ['id' => $about->id]) }}"
                                        ...
                                        <td>
                                            ...
                                            <form class="d-inline"
                                                action="{{ route('admin.abouts.delete', ['id' => $about->id]) }}"
                                                method="POST">
                                                @csrf
